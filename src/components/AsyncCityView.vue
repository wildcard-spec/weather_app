<template>
    ...
    <div class="max-w-screen-md w-full py-12">
        <div class="mx-8 text-white">
            <h2 class="mp-4">7-Day Forecast</h2>
            ...
            <img 
            class="w-[50px] h-[50px] object-hover"
    ...
    <!-- ABC -->
    <div class="flex align-center gap-2 py-12 text-white cursor-pointer duration-150 hover:text-red-500" @click="removeCity()">
...
const getWeatherData = async () => {
    try {
      ...
      `https://api.openweathermap.org/data/2.5/onecall?lat=${route.query.lat}&lon=${route.query.lng}&exclude={part}&appid=${import.meta.env.VITE_WEATHER_API_KEY}&units=metric`
    );
